...
get_game_name() {
  ...
  # Extraer el nombre del juego en español usando xmlstarlet
  local game_name=$(xmlstarlet sel -t -m "//game[id='$serial']/locale[@lang='ES']" -v 'title' -n "$db_file")
